...
const RegisterForm = async () => {
  ...
  return (
    <form className="w-full max-w-md space-y-4" action={register}>
      ...
      <button type="submit" className="w-full px-5 py-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm text-center">アカウントを登録する</button>
    </form>
  );
};
